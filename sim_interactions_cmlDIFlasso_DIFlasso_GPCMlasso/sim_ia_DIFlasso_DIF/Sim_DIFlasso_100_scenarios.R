...
library(doSNOW)
cl<-makeCluster(no_of_cores,type="SOCK", outfile="")  # Corecluster erzeugen
...
save(res_foreach, file = "results_DIFlasso_100DIFcases_100x100.Rdata")
...
df_t_and_scen_DIFlasso_DIF <- df_t_and_scen
save(df_t_and_scen_DIFlasso_DIF,
     file="df_t_DIF_diflasso_100each.Rdata")
...
df_all_reduced_DIFlasso_DIF_100x100_samples <- tbl1
save(df_all_reduced_DIFlasso_DIF_100x100_samples,
     file = "df_all_reduced_DIFlasso_DIF_100x100_samples.Rdata")
