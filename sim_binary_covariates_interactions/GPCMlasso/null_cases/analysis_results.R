...
deltapars <- lapply((1:length(res_foreach)),
...
df_all_reduced_null <- df_all_reduced
save(df_all_reduced_null,
     file = "df_all_reducednoDIF_100x100nullcases_GPCMlasso.Rdata")
...
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=Comp.time, group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n,nrow = 2) + labs(x= "Number of covariates", y="Computation time (noDIF)",color ="Number \n of items")
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=Comp.time, group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, scales = 'free',  nrow = 2) + labs(x= "number of covariates", y="Computation time (noDIF)",color ="Number \n of items")


# DIF-delta
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=get('Type I error'), group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, nrow =2) + labs(x= "number of covariates", y="Type I error (noDIF)",color ="Number \n of items")
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=get('Type I error'), group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, scales = 'free', nrow =2) + labs(x= "number of covariates", y="Type I error (noDIF)",color ="Number \n of items")

ggplot(data = df_all_reduced, aes(x=as.factor(K), y=get('Power'), group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, nrow =2) + labs(x= "number of covariates", y="Power (noDIF)",color ="Number \n of items")
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=get('Power'), group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, scales = 'free', nrow =2) + labs(x= "number of covariates", y="Power (noDIF)",color ="Number \n of items")


ggplot(data = df_all_reduced, aes(x=as.factor(K), y=Bias, group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, nrow =2) + labs(x= "number of covariates", y="Mean of estimates (noDIF)",color ="Number \n of items")
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=Bias, group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, scales = 'free', nrow =2) + labs(x= "number of covariates", y="Mean of estimates (noDIF)",color ="Number \n of items")

ggplot(data = df_all_reduced, aes(x=as.factor(K), y=Variance, group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, nrow =2) + labs(x= "number of covariates", y="Variance of estimates (noDIF)",color ="Number \n of items")
ggplot(data = df_all_reduced, aes(x=as.factor(K), y=Variance, group = I, color = as.factor(I))) + geom_line(size =.8) +
  geom_point() + facet_wrap(~ n, scales = 'free', nrow =2) + labs(x= "number of covariates", y="Variance of estimates (noDIF)",color ="Number \n of items")
