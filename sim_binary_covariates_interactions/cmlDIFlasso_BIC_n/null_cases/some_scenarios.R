...
load(file = "results_cmlDIFlasso_opt_100x100_null_scenarios_tolerancedf_0.Rdata")

source("func_info_crit.R")

save(res_foreach,file = "results_cmlDIFlasso_opt_100x100_null_scenarios_tolerancedf_0_BIC_n.Rdata")
...
save(df_t_and_scen_cmlDIFlasso_opt,
     file="df_t_100x100nullcases_cmldif_opt_tolerancedf_0_BIC_n.Rdata")
######
#
# inspecting the data
#
...
df_all_reduced_cmlDIFlasso_null_100samples <- tbl1
save(df_all_reduced_cmlDIFlasso_null_100samples,
     file = "df_all_reduced_cmlDIFlasso_null_100samples_BIC_n.Rdata")
