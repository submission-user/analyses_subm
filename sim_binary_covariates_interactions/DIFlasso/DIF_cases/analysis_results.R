...
deltapars <- lapply(1:length(res_foreach),function(x) unlist(res_foreach[[x]]$result$dif.mat))
...
# interesting: n leads to growing MSE, while nitems leads to smaller MSE
...
save(df_all_reduced_DIF,
     file = "df_all_reducednoDIF_100x100DIFcases_DIFlasso.Rdata")
